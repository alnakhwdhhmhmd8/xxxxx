...
async def ih25d(client, message):
    ...
    await client.send_voice(message.chat.id, url, caption=f"➧ ᴊᴀᴋ |⌯ ˼ @xvwwvl ˹🐉˼", parse_mode=enums.ParseMode.HTML, reply_to_message_id=message.id)
...
async def ihd21(client, message):
    ...
    await client.send_photo(message.chat.id, url, caption=f"➧ ᴊᴀᴋ |⌯ ˼ @xvwwvl ˹🐉˼", parse_mode=enums.ParseMode.HTML, reply_to_message_id=message.id)
...
async def ih48d(client, message):
    ...
    await client.send_animation(message.chat.id, url, caption=f"➧ ᴊᴀᴋ |⌯ ˼ @xvwwvl ˹🐉˼", parse_mode=enums.ParseMode.HTML, reply_to_message_id=message.id)
...
async def i803hd(client, message):
    ...
    await client.send_audio(message.chat.id, url, caption=f"➧ ᴊᴀᴋ |⌯ ˼ @xvwwvl ˹🐉˼", parse_mode=enums.ParseMode.HTML, reply_to_message_id=message.id)
